...
T:"ytp-mdx-popup-dialog",Z:{role:"dialog"},J:[{W:"div",T:"ytp-mdx-popup-dialog-inner-content",J:[{W:"div",T:"ytp-mdx-popup-title",pu:"You're signed out"},{W:"div",T:"ytp-mdx-popup-description",pu:"Videos that you watch may be added to the TV's watch history and influence TV recommendations. To avoid this, cancel and sign in to YouTube on your computer."},{W:"div",T:"ytp-mdx-privacy-popup-buttons",J:[{W:"button",d$:["ytp-button","ytp-mdx-privacy-popup-cancel"],pu:"Cancel"},{W:"button",d$:["ytp-button",
...
break;case -1:this.Pk(new g.EH(64));break;case -1E3:this.Pk(new g.EH(128,{errorCode:"mdx.remoteerror",errorMessage:"This video is not available for remote playback.",nQ:2}))}w=s9(this.Hj).trackData;var M=this.X;(w||M?w&&M&&w.trackName==M.trackName&&w.languageCode==M.languageCode&&w.languageName==M.languageName&&w.kind==M.kind:1)||(this.X=w,kJj(this,w));w=s9(this.Hj);w.volume===-1||Math.round(this.U.getVolume())===w.volume&&this.U.isMuted()===w.muted||this.S.isActive()||this.Dd()}else BGA(this)};
